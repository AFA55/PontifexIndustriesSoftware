-- Add is_multi_day and total_days_worked to active_job_orders view
-- Required for operators to see correct day number on multi-day projects
-- Also enables the job-orders API to return these fields
