-- Add jobsite_conditions, site_compliance, equipment_selections, equipment_rentals,
-- scope_details, additional_info to schedule_board_view for enhanced approval modal
