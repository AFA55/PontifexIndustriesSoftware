/**
 * Pontifex Industries — Electronic Signature Consent (ESIGN Act / UETA)
 */
...
2. I have the right to withdraw this consent at any time by contacting pontifexindustries@gmail.com.
...
export function getEsignConsentHTML(): string {
  return `
    ...
    <a href="mailto:pontifexindustries@gmail.com" style="color: #7c3aed;">pontifexindustries@gmail.com</a>.</p>
  `;
}
