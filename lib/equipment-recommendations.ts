...
export const SCOPE_RECOMMENDATIONS: ScopeRecommendation[] = [
  {
    ...
    items: [
      { key: 'hydraulic_hose', label: 'Hydraulic Hose', inputType: 'quantity_ft', placeholder: '0', suffix: 'ft', defaultSelected: true },
      { key: 'gas_power_pack', label: 'Gas Power Pack', inputType: 'checkbox', defaultSelected: true },
      { key: 'chalk_line', label: 'Chalk Line', inputType: 'checkbox', defaultSelected: true },
      { key: 'clear_spray', label: 'Clear Spray', inputType: 'checkbox', defaultSelected: true },
      { key: 'tape', label: 'Tape', inputType: 'checkbox', defaultSelected: true },
      { key: 'plastic', label: 'Plastic', inputType: 'checkbox', defaultSelected: true },
