    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-gray-50">
          <h2 className="text-sm font-bold text-gray-800">Dashboard Settings</h2>
          <button
            onClick={onClose}
          ...
          {activeTab === 'widgets' && (
            <div className="p-4 space-y-5">
                    ...
                    {widgets.map((widget) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-all text-left group"
                        >
                          <div
                          ...
                          <div
                            className={`w-9 h-5 rounded-full flex items-center transition-all flex-shrink-0 ${
                              isActive ? 'bg-blue-600 justify-end' : 'bg-gray-200 justify-start'
                            }`}
                          >
              ...
              {Object.keys(widgetsByCategory).length === 0 && (
                <p className="text-sm text-gray-400 text-center py-8">No widgets available for your role.</p>
              )}
            </div>
          )}
          ...
          {activeTab === 'presets' && (
            <div className="p-4 space-y-3">
              ...
              {availablePresets.map((preset) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-start gap-3 p-3 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50/30 transition-all text-left group"
                  >
              ...
              {availablePresets.length === 0 && (
                <p className="text-sm text-gray-400 text-center py-8">No presets available for your role.</p>
              )}
            </div>
          )}
                  ...
                  {DENSITY_OPTIONS.map((option) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-400">{option.value}px</span>
                      </button>
                    );
                  })}
                </div>
