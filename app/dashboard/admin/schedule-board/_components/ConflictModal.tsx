        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm animate-in zoom-in-95 duration-200">
          ...
          <div className="p-5 space-y-4">
            <p className="text-sm text-gray-700">
              ...
              <span className="font-bold text-gray-900">{currentJobName}</span>
              {' '}today.
            </p>
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 bg-blue-50 hover:bg-blue-100 border-2 border-blue-200 hover:border-blue-300 rounded-xl text-left transition-all"
              >
                <Plus className="w-5 h-5 text-blue-600 flex-shrink-0" />
                <div>
                  <p className="font-bold text-gray-900 text-sm">Add as 2nd Job</p>
                  <p className="text-xs text-gray-500">Keep current job and add {newJobName} too</p>
                </div>
              </button>

              <button
                onClick={onMoveToJob}
                className="w-full flex items-center gap-3 px-4 py-3 bg-purple-50 hover:bg-purple-100 border-2 border-purple-200 hover:border-purple-300 rounded-xl text-left transition-all"
              >
                <ArrowRight className="w-5 h-5 text-purple-600 flex-shrink-0" />
                <div>
                  <p className="font-bold text-gray-900 text-sm">Move to {newJobName}</p>
                  <p className="text-xs text-gray-500">Remove from {currentJobName} and assign here</p>
                </div>
              </button>
            </div>
