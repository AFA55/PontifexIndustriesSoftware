      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-gradient-to-r from-brand to-brand-accent hover:from-brand-dark hover:to-brand-accent text-white text-sm font-semibold shadow-lg shadow-brand/30 transition-all hover:-translate-y-0.5"
          >
      ...
      <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <section className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link
              href="/dashboard/admin/site-visits"
              className="text-xs font-semibold text-brand dark:text-brand hover:underline inline-flex items-center gap-0.5"
            >
          ...
          {loading ? (
            ...
            <div className="py-8 text-center">
              ...
              <Link
                href="/dashboard/admin/site-visits/new"
                className="text-sm font-semibold text-brand dark:text-brand hover:underline"
              >
            ...
            <ul className="space-y-2">
              {visits.slice(0, 5).map((v) => (
                <li
                  key={v.id}
                  className="p-3 rounded-lg border border-gray-100 dark:border-slate-700 hover:border-brand/40 dark:hover:border-brand/40 transition"
                >
