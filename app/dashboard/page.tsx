  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0b0618]">
      ...
      {showWalkthrough && isDemoOperator && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-fade-in-up">
            {/* Header */}
            <div className="bg-gradient-to-r from-brand to-brand-accent p-8 rounded-t-3xl text-white">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="bg-brand/10 border-2 border-brand/30 rounded-2xl p-6">
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-brand to-brand-accent rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="p-6 bg-gray-50 rounded-b-3xl border-t-2 border-gray-200">
              <button
                ...
                className="w-full px-6 py-4 bg-gradient-to-r from-brand to-brand-accent hover:opacity-90 text-white rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-200"
              >
                Start Exploring! 🎯
              </button>
            </div>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-br from-brand to-brand-accent rounded-full opacity-10 blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8 relative">
        ...
        <div className="text-center mb-8 sm:mb-10 animate-fade-in">
          <div className="w-full">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-brand via-brand to-brand-accent bg-clip-text text-transparent mb-3 animate-gradient drop-shadow-sm">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <Link href="/dashboard/my-jobs" className="bg-gradient-to-br from-brand to-brand-accent rounded-2xl p-5 sm:p-6 shadow-xl flex-1 max-w-[160px] transform hover:scale-105 transition-all block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-white to-brand/5 dark:from-white/[0.05] dark:to-brand/10 p-1.5 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.03] text-left animate-fade-in-up delay-200"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-brand to-brand-accent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
            <div className="relative bg-white/95 dark:bg-white/[0.05] backdrop-blur-sm rounded-[22px] p-7 group-hover:bg-transparent transition-colors duration-500">
              <div className="flex items-start justify-between mb-5">
                <div className="w-16 h-16 bg-gradient-to-br from-brand to-brand-accent rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transform group-hover:rotate-6 transition-all duration-300 ring-4 ring-brand/10 dark:ring-brand/20 group-hover:ring-white/30">
                  <svg className="w-8 h-8 text-white drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <span className="px-4 py-2 bg-brand/10 dark:bg-brand/20 group-hover:bg-white/20 text-brand dark:text-brand group-hover:text-white text-xs font-bold rounded-full transition-all duration-300 shadow-md">
              ...
              <div className="mt-5 flex items-center text-brand dark:text-brand group-hover:text-white font-bold transition-colors duration-300">
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-white to-brand/5 dark:from-white/[0.05] dark:to-brand/10 p-1.5 shadow-2xl hover:shadow-3xl transition-all duration-500 text-left animate-fade-in-up delay-300 hover:scale-[1.03]"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-brand to-brand-accent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
            <div className="relative bg-white/95 dark:bg-white/[0.05] backdrop-blur-sm rounded-[22px] p-7 group-hover:bg-transparent transition-colors duration-500">
              <div className="flex items-start justify-between mb-5">
        ...
        <div className="mt-10 max-w-5xl mx-auto">
          <div className="bg-white/90 dark:bg-white/[0.05] backdrop-blur-xl rounded-3xl p-6 shadow-2xl border-2 border-white/50 dark:border-white/10">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2">
              ...
              <Link
                href="/dashboard/timecard"
                className="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-brand to-brand-accent hover:opacity-90 text-white rounded-xl font-bold whitespace-nowrap transition-all shadow-lg hover:shadow-xl hover:scale-105"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
