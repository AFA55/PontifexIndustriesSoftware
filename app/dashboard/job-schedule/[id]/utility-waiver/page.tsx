...
export default function UtilityWaiverPage() {
  ...
  if (loadingJob) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-brand/5 to-brand/5 flex items-center justify-center">
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-brand/5 to-brand/5 flex items-center justify-center p-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-brand/5 to-brand/5">
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-900 via-brand to-brand-dark text-white sticky top-0 z-10 shadow-2xl pt-safe">
      ...
      <div className="container mx-auto px-4 py-6 max-w-lg space-y-5 pb-12">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-slate-300 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand focus:border-brand text-base"
            />
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
          ...
          <div className={`border-2 rounded-xl overflow-hidden transition-colors ${hasSignature ? 'border-brand/30' : 'border-dashed border-slate-300'}`}>
            <canvas
              ref={canvasRef}
              width={600}
              height={200}
        ...
        <button
          ...
          className={`w-full py-4 rounded-2xl font-bold text-base transition-all shadow-lg flex items-center justify-center gap-3 ${
            submitting || !signerName.trim() || !hasSignature
              ...
              : 'bg-gradient-to-r from-brand to-brand-accent hover:opacity-90 text-white'
          }`}
        >
          {submitting ? (
