...
- [ ] **🔴 FOUNDER DECISION — 15 work-item rows may still be over-billing, and only you can say.** A later day repeats an earlier day's *exact* figure on the same job. Almost certainly the same artifact, but there is **no clean mechanical discriminator** — 9 of the 18 carry-over rows have full `details_json`, indistinguishable from operator-entered work — so guessing at billing figures is not repair. The list: Parkk 424813 (WALL SAW 132 first logged 8/4, repeats 8/5, 8/6, 8/13; 31 from 8/7 repeats 8/13; 57 from 8/10 repeats 8/13; 44 from 8/12 repeats 8/13; CORE DRILL 7 from 8/4 repeats 8/13) · Pratt 895358 (SLAB SAW 200 from 8/11 repeats 8/13; 300 and 700 from 8/12 repeat 8/13) · Parkk 402357 (SLAB SAW 190 from 8/5 repeats 8/6 and 8/7) · Collins 124747 (SLAB SAW 106 from 8/5 repeats 8/6) · Door Systems 364026 (HAND SAW 2, PUSH SAW 6, both 8/5 repeating 8/6) · Harper 631148 (CORE DRILL 7, ELECTRIC CORE DRILL 1, both 8/4 repeating 8/5) · J. Davis 859542 (SLAB SAW 1 from 8/7 repeats 8/10). Say which are real repeat cuts and the rest get deleted in one command. Backup: `_work_items_backup_20260814`.
