            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                <p className="text-gray-700 leading-relaxed">
                  I acknowledge that <strong>the Company</strong> has completed the contracted services at the above location as described. The work has been performed in accordance with the scope of services requested.
                </p>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                  <p>
                    <strong>Limitation of Liability:</strong> the Company' liability for any claim arising out of this agreement shall not exceed the total amount paid for the services rendered. We shall not be liable for any indirect, incidental, special, or consequential damages.
                  </p>
                  <p>
                    <strong>Indemnification:</strong> Customer agrees to indemnify, defend, and hold harmless the Company, its officers, employees, and agents from any claims, damages, losses, or expenses (including reasonable attorney fees) arising from: (a) Customer's breach of this agreement; (b) Customer's use of the services or work product; (c) Any third-party claims related to the work performed at Customer's premises.
                  </p>
                  <p>
                    <strong>Underground Utilities:</strong> Customer warrants that all underground utilities have been properly marked and disclosed. the Company is not liable for damage to unmarked or incorrectly marked utilities.
                  </p>
                  <p>
