    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.companyName}>WORK ORDER AGREEMENT</Text>
        ...
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningText}>
            the Company assumes NO responsibility for water damage, moisture intrusion, or water-related issues resulting from wet cutting operations, including damage to flooring, walls, ceilings, electrical systems, or stored materials.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            the Company may provide layout assistance as a courtesy. However, Customer acknowledges that the Company shall not be liable for any errors in layouts provided. Customer is solely responsible for verifying accuracy of all layouts prior to commencement of work.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            Customer agrees to indemnify, defend, and hold harmless the Company from any claims, damages, or expenses arising from Customer's negligence, inaccurate information, or failure to fulfill obligations under this Agreement.
          </Text>
        </View>
        ...
        {cutThroughAuthorized && (
          <View style={styles.warningBox}>
            ...
            <Text style={styles.warningText}>
              Customer has authorized the Company to cut through, near, or around marked obstructions. Customer assumes 100% of risk and liability for all resulting damages and agrees to indemnify the Company from all claims.
            </Text>
        ...
        <View style={styles.footer}>
          <Text>Work Order Agreement | Generated by Operations Platform</Text>
