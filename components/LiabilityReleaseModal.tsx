              ...
              <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-900">
                    <strong>I have read and accept</strong> all terms and conditions stated above, including the liability release and indemnification provisions. I understand that I am signing this agreement on behalf of Patriot Concrete Cutting before beginning work.
                  </span>
                </label>
              </div>
